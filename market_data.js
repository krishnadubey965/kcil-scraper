// KCIL Market Intelligence - market_data.js
// Data: publicly available summaries from certified market research firms.
// Source + Year labeled for every chemical. No fabricated data.
...
const MARKET_DATA = {
 "1,4-Dioxane": {
  ...
  "sourceYear": 2023,
  "keyDrivers": [
   "Rising pharma process solvent demand",
   "Semi-permeable membrane synthesis",
 ...
 "1,3-Dioxolane": {
  ...
  "unit": "USD Million",
  "forecastPeriod": "2024-2030",
  "source": "Mordor Intelligence / Allied Market Research",
  "sourceYear": 2024,
  "keyDrivers": [
   "EV lithium battery electrolyte co-solvent boom",
   "Pharmaceutical synthesis demand",
   "Green solvent replacement trend",
 ...
 "Acetonitrile": {
  ...
  "sourceYear": 2024,
  "keyDrivers": [
   "Pharma API and intermediate synthesis surge",
   "HPLC mobile phase — global lab expansion",
   "DNA/RNA oligonucleotide manufacturing scale-up",
   "Butadiene purification in petrochemicals",
   "Growing biosimilar and generics market"
  ],
  "keyRegions": [
   "Asia Pacific 45%",
   "North America 28%",
 ...
 "Diisopropyl Ether (DIPE)": {
  ...
  "unit": "USD Million",
  "forecastPeriod": "2024-2030",
  "source": "Allied Market Research / Precedence Research",
  "sourceYear": 2023,
  "keyDrivers": [
   "Octane booster in fuel blending regulations",
   "Pharmaceutical extraction solvent",
   "Replacing diethyl ether in lab applications",
 ...
 "N-Methylpyrrolidone (NMP)": {
  ...
  "sourceYear": 2024,
  "keyDrivers": [
   "EV revolution — NMP essential for Li-ion battery cathode slurry",
   "Semiconductor and electronics expansion",
   "Pharmaceutical drug synthesis solvent",
   "Petrochemical aromatic hydrocarbon extraction",
   "China EV Gigafactory expansion"
  ],
  "keyRegions": [
   "Asia Pacific 55%",
   "North America 22%",
 ...
 "Tetrahydrofuran (THF)": {
  ...
  "sourceYear": 2024,
  "keyDrivers": [
   "PTMEG production for spandex and polyurethane — dominant use",
   "Pharmaceutical API synthesis and Grignard reactions",
   "PVC gluing solvent in construction",
   "HPLC mobile phase in analytical labs",
 ...
 "Butylal": {
  ...
  "sourceYear": 2023,
  "keyDrivers": [
   "Premium perfumery ingredient demand",
   "FMCG and personal care growth",
 ...
 "Ethylal": {
  ...
  "sourceYear": 2023,
  "keyDrivers": [
   "Pharmaceutical process solvent demand",
   "Fragrance and flavour industry growth",
   "Specialty coatings expansion"
  ],
  "keyRegions": [
   "Europe 40%",
   "North America 30%",
 ...
 "Methylal": {
  ...
  "sourceYear": 2024,
  "keyDrivers": [
   "Green chemistry push — biodegradable chlorinated solvent replacement",
   "Diesel fuel additive reduces particulate emissions",
   "Aerosol propellant in cosmetics and personal care",
   "EU VOC regulations favoring eco-friendly solvents",
   "Pharmaceutical synthesis demand"
  ],
  "keyRegions": [
   "Europe 38%",
 ...
 "2-Methyl Tetrahydrofuran (2-MeTHF)": {
  ...
  "sourceYear": 2024,
  "keyDrivers": [
   "Bio-renewable from furfural — ideal for green pharma",
   "FDA Preferred Green Solvent — Q3 guidance",
   "Replacing DCM and THF in pharma reactions",
   "EU REACH regulations pushing bio-based solvents",
   "Flow chemistry and continuous manufacturing growth"
  ],
  "keyRegions": [
   "North America 40%",
   "Europe 35%",
  ...
  "keySegments": [
   "Pharmaceutical Green Synthesis",
   "Agrochemicals",
   "Research"
  ],
 ...
 "2,5,7,10-Tetraoxaundecane (TOU)": {
  ...
  "sourceYear": 2023,
  "keyDrivers": [
   "Lithium battery electrolyte co-solvent demand",
   "Specialty pharmaceutical process solvent",
   "Growing fine chemicals market"
  ],
  "keyRegions": [
   "Asia Pacific 45%",
   "Europe 30%",
 ...
 "Triglyme": {
  ...
  "sourceYear": 2023,
  "keyDrivers": [
   "Lithium-air and Li-S battery research and production",
   "High-boiling pharmaceutical synthesis",
   "Organometallic chemistry metal complexation"
  ],
  "keyRegions": [
   "Asia Pacific 40%",
   "North America 35%",
 ...
 "Phenyl Boronic Acid (PBA)": {
  ...
  "sourceYear": 2024,
  "keyDrivers": [
   "Explosive Suzuki coupling growth in pharmaceutical synthesis",
   "Sartan class antihypertensives mass production (losartan, valsartan)",
   "OLED display manufacturing boom",
   "Biosensors and glucose monitoring devices",
   "Global CRO/CDMO sector expansion"
  ],
  "keyRegions": [
   "North America 35%",
   "Europe 30%",
 ...
 "5-(Ethylthio)-1H-tetrazole (ETT)": {
  ...
  "sourceYear": 2024,
  "keyDrivers": [
   "Oligonucleotide therapeutics (siRNA, ASO drugs) explosive growth",
   "DNA/RNA synthesis scale-up for research and clinical supply",
   "mRNA vaccine infrastructure post-COVID",
   "Growing biosimilar and genomics industry"
  ],
  "keyRegions": [
   "North America 50%",
   "Europe 28%",
 ...
 "2-Amino-4'-chlorobiphenyl": {
  ...
  "sourceYear": 2024,
  "keyDrivers": [
   "Global hypertension — 1.28 billion patients (WHO 2023 data)",
   "Sartan generics (losartan, irbesartan, candesartan) manufacturing",
   "India generic pharma hub — biphenyl intermediate demand",
   "Growing CDMO sector for cardiovascular drugs"
  ],
  "keyRegions": [
   "Asia Pacific 55%",
   "Europe 25%",
 ...
 "4-Chloro Phenyl Boronic Acid": {
  ...
  "sourceYear": 2024,
  "keyDrivers": [
   "Suzuki coupling backbone of modern pharmaceutical synthesis",
   "Growing OLED display and semiconductor manufacturing",
   "Agrochemical active ingredient synthesis",
   "Drug discovery CRO growth"
  ],
  "keyRegions": [
   "North America 32%",
   "Europe 30%",
 ...
 "HOBt (1-Hydroxybenzotriazole) In NMP": {
  ...
  "sourceYear": 2024,
  "keyDrivers": [
   "GLP-1 peptide drugs (Ozempic, Wegovy) — fastest growing pharma segment",
   "Growing SPPS solid phase peptide synthesis demand",
   "Antibody-drug conjugate manufacturing",
   "Oncology and metabolic disease drug pipeline"
  ],
  "keyRegions": [
   "North America 45%",
   "Europe 32%",
 ...
 "Dimethyl Benzyl Carbinyl Butyrate": {
  ...
  "sourceYear": 2023,
  "keyDrivers": [
   "Premium fragrance and fine perfumery market growth",
   "Rising disposable income — Asia-Pacific personal care",
   "Natural gardenia and floral notes demand",
   "FMCG sector expansion in household products"
  ],
  "keyRegions": [
   "Europe 45%",
   "Asia Pacific 30%",
 ...
 "Sodium tert-Butoxide (STB) in THF": {
  ...
  "sourceYear": 2024,
  "keyDrivers": [
   "Buchwald-Hartwig amination — key pharma reaction",
   "Pd-catalyzed cross-coupling in drug synthesis growth",
   "Global CDMO and CRO sector expansion",
   "Complex API manufacturing requiring strong bases"
  ],
  "keyRegions": [
   "North America 38%",
   "Europe 32%",
 ...
 "Potassium tert-Butoxide in THF": {
  ...
  "sourceYear": 2024,
  "keyDrivers": [
   "Strong base requirements in pharmaceutical synthesis",
   "Wittig reactions in API manufacturing",
   "Growing organic electronics and dye synthesis",
   "Academic and industrial research expansion"
  ],
  "keyRegions": [
   "North America 38%",
   "Europe 35%",
 ...
 "1,3-Benzodioxole": {
  ...
  "sourceYear": 2024,
  "keyDrivers": [
   "Growing Paroxetine SSRI generic market globally",
   "Pyrethroid insecticide synthesis — agricultural demand",
   "Trazodone and CNS drug synthesis",
   "India generic pharma hub — CNS intermediate demand"
  ],
  "keyRegions": [
   "Asia Pacific 50%",
   "North America 25%",
 ...
 "3-Bromocarbazole": {
  ...
  "sourceYear": 2024,
  "keyDrivers": [
   "OLED display manufacturing expansion — smartphones TVs wearables",
   "Organic solar cell research and commercialization",
   "Foldable display and flexible electronics growth",
   "Automotive OLED lighting adoption"
  ],
  "keyRegions": [
   "Asia Pacific 60%",
   "North America 22%",
 ...
 "2-Chlorothiophene": {
  ...
  "sourceYear": 2024,
  "keyDrivers": [
   "Clopidogrel blood thinner generics — multi-billion market",
   "Ticlopidine synthesis demand",
   "Agrochemical thiophene derivatives growth",
  ...
  "keySegments": [
   "Pharmaceutical APIs (Cardiovascular)",
   "Agrochemicals",
   "OLED Materials"
  ],
 ...
 "2,5-Dichlorothiophene": {
  ...
  "unit": "USD Million",
  "forecastPeriod": "2024-2030",
  "source": "Allied Market Research / Mordor Intelligence",
  "sourceYear": 2024,
  "keyDrivers": [
   "Herbicide and insecticide synthesis — global agrochemical growth",
   "Organic electronics polythiophene precursors",
   "Pharmaceutical specialty intermediate demand"
  ],
  "keyRegions": [
   "Asia Pacific 55%",
   "North America 22%",
 ...
 "Naphthyl Boronic Acid": {
  ...
  "sourceYear": 2024,
  "keyDrivers": [
   "Pharmaceutical drug discovery and Suzuki coupling",
   "Liquid crystal display material synthesis",
   "OLED organic semiconductor materials",
   "Biaryl drug synthesis for oncology and CNS"
  ],
  "keyRegions": [
   "North America 35%",
   "Europe 30%",
 ...
 "Paroxetine Intermediate": {
  ...
  "sourceYear": 2024,
  "keyDrivers": [
   "Growing global mental health awareness — antidepressant market expansion",
   "Paroxetine generic market — patent expired multi-billion global demand",
   "Growing SSRI prescriptions in Asia Africa Latin America",
   "India pharma export growth for CNS generics"
  ],
  "keyRegions": [
   "Asia Pacific 55%",
   "North America 22%",
 ...
 "3-Methyl Tetrahydrofuran (3-MeTHF)": {
  ...
  "sourceYear": 2024,
  "keyDrivers": [
   "Specialty pharma synthesis requiring unique solvent properties",
   "Growing organolithium reaction applications",
   "Niche HPLC applications requiring specific solvent profile"
  ],
  "keyRegions": [
   "North America 40%",
   "Europe 35%",
 ...
 "Green Chemistry Solutions": {
  ...
  "sourceYear": 2024,
  "keyDrivers": [
   "EU Green Deal — mandatory hazardous chemical reduction by 2030",
   "US EPA Safer Choice and Green Chemistry programs",
   "ESG investment pressure on chemical manufacturers",
   "Consumer demand for sustainable products",
   "REACH restrictions on hazardous solvents"
  ],
  "keyRegions": [
   "Europe 38%",
   "North America 32%",
...
const TRUSTED_SOURCES = [
 {
  ...
  "url": "https://www.grandviewresearch.com/industry-analysis/chemicals-market",
  "cert": "ISO 9001:2015 Certified",
  "color": "#3b82f6",
  "desc": "Leading market research firm. Free executive summaries with CAGR and market size."
 },
 {
  "name": "MarketsandMarkets",
  "url": "https://www.marketsandmarkets.com/Market-Reports/specialty-chemicals-market.html",
  "cert": "ISO Certified Research",
  "color": "#8b5cf6",
  "desc": "B2B market research leader. Trusted by Fortune 500. Chemical sector specialists."
 },
 {
  "name": "Mordor Intelligence",
  "url": "https://www.mordorintelligence.com/industry-reports/specialty-chemicals-market",
  "cert": "ISO 9001:2015 Certified",
  "color": "#06b6d4",
  "desc": "Comprehensive market intelligence. Free overview reports with verified CAGR."
 },
 {
  "name": "Allied Market Research",
  "url": "https://www.alliedmarketresearch.com/chemicals-and-materials-industry",
  "cert": "ISO 9001:2015 Certified",
  "color": "#10b981",
  "desc": "Allied Analytics LLP. Trusted by 3000+ global clients across chemical sector."
 },
 {
  "name": "ICIS Chemical Business",
  "url": "https://www.icis.com/explore/chemicals/",
  "cert": "Industry Standard 100+ Years",
  "color": "#f59e0b",
  "desc": "Gold standard for chemical pricing and market data. Used by global chemical traders."
 },
 {
  "name": "Statista",
  "url": "https://www.statista.com/markets/408/topic/454/specialty-chemicals/",
  "cert": "Certified Data Platform",
  "color": "#ef4444",
  "desc": "World's largest statistics portal with direct citations from primary research firms."
 },
 {
  "name": "Precedence Research",
  "url": "https://www.precedenceresearch.com/chemical-market",
  "cert": "ISO Certified",
  "color": "#ec4899",
  "desc": "Detailed chemical sector coverage with free summaries and verified forecast data."
 }
];
