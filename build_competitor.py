...
KCIL = {
  ...
  "employees": "200-500",
  "categories": ["Solvents","Specialty Chemicals","Custom Synthesis","Green Chemistry"],
  "productCount": 29,
  "keyStrengths": [
  ...
  "keyMarkets": ["Pharmaceutical APIs","Agrochemicals","OLED & Electronics","Fragrances","Battery Materials","Green Chemistry"]
}
...
COMPETITORS = [
  {
    ...
    "threatLevel": "HIGH",
    "sharedChemicals": ["Acetonitrile","Ethyl Acetate","Specialty Solvents"],
  ...
  },
  {
    ...
    "threatLevel": "HIGH",
    "sharedChemicals": ["N-Methylpyrrolidone (NMP)","Specialty Solvents","Pharma Process Solvents"],
  ...
  },
  {
    ...
    "sharedChemicals": ["Tetrahydrofuran (THF)","Acetonitrile","Specialty Solvents","Fine Chemicals"],
  ...
  },
  {
    ...
    "threatLevel": "MEDIUM",
    "sharedChemicals": ["Specialty Solvents","Fine Chemicals","Analytical Reagents"],
  ...
  },
  {
    ...
    "sharedChemicals": ["N-Methylpyrrolidone (NMP)","Tetrahydrofuran (THF)","Specialty Solvents","Pharmaceutical Chemicals"],
  ...
  },
  {
    ...
    "sharedChemicals": ["Tetrahydrofuran (THF)","Specialty Solvents","1,4-Dioxane","Chemical Intermediates"],
  ...
  },
  {
    ...
    "sharedChemicals": ["ALL 29 KCIL products", "Acetonitrile","THF","NMP","1,4-Dioxane","Boronic Acids","ETT","HOBt in NMP","All Specialty Intermediates"],
  ...
  },
  {
    ...
    "sharedChemicals": ["Phenyl Boronic Acid","4-Chloro Phenyl Boronic Acid","Naphthyl Boronic Acid","ETT","HOBt","Specialty Intermediates","THF","Acetonitrile"],
  ...
  },
  {
    ...
    "sharedChemicals": ["N-Methylpyrrolidone (NMP)","Specialty Solvents","Chemical Intermediates"],
  ...
  },
  {
    ...
    "sharedChemicals": ["Specialty Chemicals for Pharma","Industrial Chemical Intermediates"],
...
import os, json
BASE = r'c:\Users\Krish\.gemini\antigravity\brain\29575ca1-6451-41bf-9741-1aeaeeba93b5\artifacts\Kcil Scrapper'
with open(os.path.join(BASE, 'competitor_data.js'), 'w', encoding='utf-8') as f:
    f.write("// KCIL Competitor Analysis - competitor_data.js\n")
    f.write("// All competitor data from publicly available sources (BSE, NSE, company websites, annual reports).\n\n")
    f.write("const KCIL_PROFILE = " + json.dumps(KCIL, ensure_ascii=False, indent=1) + ";\n\n")
    f.write("const COMPETITORS = " + json.dumps(COMPETITORS, ensure_ascii=False, indent=1) + ";\n\n")
sz = os.path.getsize(os.path.join(BASE, 'competitor_data.js'))
print(f"competitor_data.js written: {sz} bytes ({sz//1024} KB), {len(COMPETITORS)} competitors")
